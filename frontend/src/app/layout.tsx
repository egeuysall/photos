...
// TODO: Fill these
export const name = 'Ege Uysal Photography: Innovate. Optimize. Create.';

/**
 * The main image URL for the site or application.
 * @type {string}
 */
export const image = '/banner.png';
...
export const description =
  'Explore the photography portfolio of Ege Uysal, showcasing minimalist and creative photo collections that capture unique moments with clarity and style.';

/**
 * The template string for dynamic page titles or metadata.
 * @type {string}
 */
const template = 'Ege Uysal Photography';

/**
 * The base URL of the site.
 * @type {string}
 */
const siteUrl = 'http://www.photos.egeuysal.com';
 ...
 * @type {string}
 */
const imageDescription = 'Photos image';
